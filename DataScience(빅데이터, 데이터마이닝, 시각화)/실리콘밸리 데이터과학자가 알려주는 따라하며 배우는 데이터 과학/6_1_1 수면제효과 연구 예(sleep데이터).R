...
# 일반적인 경우 이것만 보면 아래와 같이 "확정적인 성격의 확실한결론"을 낼 것이다.
# [일반적인 결론] 수면제는 효과가 있다.(0.75시간 수면시간 증가)
# 반면 통계학의 경우는 "확률적인 성격의 불확실결론"을 낼 것이다. 아래의 t-검정을 보자.
...
# [통계학적 결론] 이 수면제는 효과가 없다. 근거는 아래와 같다.
# 근거(1) (P값 - 표본평균 수면시간 증가값이 관측될 확률 11% 근거함)
# 근거(2) 평균 수면시간의 증가에 대한 95% 신뢰구간이 -0.53, 2.03dlek   
